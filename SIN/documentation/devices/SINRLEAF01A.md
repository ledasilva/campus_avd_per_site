...
| Ethernet51 | MLAG_SINRLEAF02A_Ethernet51 | *trunk | *- | *- | *MLAG | 51 |
| Ethernet52 | MLAG_SINRLEAF02A_Ethernet52 | *trunk | *- | *- | *MLAG | 51 |
...
| --------- | ----------- | ------------- | ---------- | --- | --- | -------- | ------ | ------- |
| Ethernet49 | P2P_SINRSPINE01A_Ethernet1 | - | 10.255.2.1/31 | default | 9214 | False | - | - |
| Ethernet50 | P2P_SINRSPINE02A_Ethernet1 | - | 10.255.2.3/31 | default | 9214 | False | - | - |
...
interface Ethernet49
   description P2P_SINRSPINE01A_Ethernet1
   no shutdown
   mtu 9214
   no switchport
...
interface Ethernet50
   description P2P_SINRSPINE02A_Ethernet1
   no shutdown
   mtu 9214
   no switchport
...
interface Ethernet51
   description MLAG_SINRLEAF02A_Ethernet51
   no shutdown
   channel-group 51 mode active
!
interface Ethernet52
   description MLAG_SINRLEAF02A_Ethernet52
   no shutdown
   channel-group 51 mode active
```
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | --------------------- | ------------------ | ------- | -------- |
| Port-Channel51 | MLAG_SINRLEAF02A_Port-Channel51 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel51
   description MLAG_SINRLEAF02A_Port-Channel51
   no shutdown
...
| 10.255.2.0 | 65200 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.255.2.2 | 65200 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 10.255.0.1:20010 | 20010:20010 | - | - | learned |
| 20 | 10.255.0.1:20020 | 20020:20020 | - | - | learned |
...
router bgp 65201
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description SINRLEAF02A
   ...
   neighbor 10.255.2.0 remote-as 65200
   neighbor 10.255.2.0 description SINRSPINE01A_Ethernet1
   neighbor 10.255.2.2 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.2.2 remote-as 65200
   neighbor 10.255.2.2 description SINRSPINE02A_Ethernet1
   neighbor 10.255.3.1 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 10.255.3.1 description SINRLEAF02A_Vlan4093
   ...
   vrf TEST_VRF
      ...
      update wait-install
      neighbor 10.255.3.1 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.3.1 description SINRLEAF02A_Vlan3000
