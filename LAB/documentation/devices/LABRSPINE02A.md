...
| --------- | ----------- | ------------- | ---------- | --- | --- | -------- | ------ | ------- |
| Ethernet1 | P2P_LABRLEAF01A_Ethernet50 | - | 10.255.2.2/31 | default | 9214 | False | - | - |
| Ethernet2 | P2P_LABRLEAF02A_Ethernet50 | - | 10.255.2.6/31 | default | 9214 | False | - | - |
| Ethernet3 | P2P_LABRLEAF03A_Ethernet54 | - | 10.255.2.10/31 | default | 9214 | False | - | - |
...
!
interface Ethernet1
   description P2P_LABRLEAF01A_Ethernet50
   no shutdown
   mtu 9214
   no switchport
...
!
interface Ethernet2
   description P2P_LABRLEAF02A_Ethernet50
   no shutdown
   mtu 9214
   no switchport
...
!
interface Ethernet3
   description P2P_LABRLEAF03A_Ethernet54
   no shutdown
   mtu 9214
   no switchport
...
| 10.255.2.7 | 65101 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
router bgp 65100
   ...
   neighbor 10.255.2.3 description LABRLEAF01A_Ethernet50
   neighbor 10.255.2.7 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.2.7 remote-as 65101
   neighbor 10.255.2.7 description LABRLEAF02A_Ethernet50
   neighbor 10.255.2.11 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.2.11 remote-as 65103
   neighbor 10.255.2.11 description LABRLEAF03A_Ethernet54
