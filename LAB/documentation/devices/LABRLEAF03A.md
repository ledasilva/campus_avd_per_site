...
| --------- | ----------- | ------------- | ---------- | --- | --- | -------- | ------ | ------- |
| Ethernet53 | P2P_LABRSPINE01A_Ethernet3 | - | 10.255.2.9/31 | default | 9214 | False | - | - |
| Ethernet54 | P2P_LABRSPINE02A_Ethernet3 | - | 10.255.2.11/31 | default | 9214 | False | - | - |
...
interface Ethernet53
   description P2P_LABRSPINE01A_Ethernet3
   no shutdown
   mtu 9214
   no switchport
...
interface Ethernet54
   description P2P_LABRSPINE02A_Ethernet3
   no shutdown
   mtu 9214
   no switchport
...
router bgp 65103
   ...
   neighbor 10.255.2.8 description LABRSPINE01A_Ethernet3
   neighbor 10.255.2.10 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.2.10 remote-as 65100
   neighbor 10.255.2.10 description LABRSPINE02A_Ethernet3
