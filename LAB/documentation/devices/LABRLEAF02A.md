...
| Ethernet51 | MLAG_LABRLEAF01A_Ethernet51 | *trunk | *- | *- | *MLAG | 51 |
| Ethernet52 | MLAG_LABRLEAF01A_Ethernet52 | *trunk | *- | *- | *MLAG | 51 |
...
| --------- | ----------- | ------------- | ---------- | --- | --- | -------- | ------ | ------- |
| Ethernet49 | P2P_LABRSPINE01A_Ethernet2 | - | 10.255.2.5/31 | default | 9214 | False | - | - |
| Ethernet50 | P2P_LABRSPINE02A_Ethernet2 | - | 10.255.2.7/31 | default | 9214 | False | - | - |
...
interface Ethernet49
   description P2P_LABRSPINE01A_Ethernet2
   no shutdown
   mtu 9214
   no switchport
...
interface Ethernet50
   description P2P_LABRSPINE02A_Ethernet2
   no shutdown
   mtu 9214
   no switchport
...
interface Ethernet51
   description MLAG_LABRLEAF01A_Ethernet51
   no shutdown
   channel-group 51 mode active
!
interface Ethernet52
   description MLAG_LABRLEAF01A_Ethernet52
   no shutdown
   channel-group 51 mode active
```
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | --------------------- | ------------------ | ------- | -------- |
| Port-Channel51 | MLAG_LABRLEAF01A_Port-Channel51 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel51
   description MLAG_LABRLEAF01A_Port-Channel51
   no shutdown
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 10.255.0.2:10010 | 10010:10010 | - | - | learned |
| 20 | 10.255.0.2:10020 | 10020:10020 | - | - | learned |
...
router bgp 65101
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description LABRLEAF01A
   ...
   neighbor 10.255.2.4 description LABRSPINE01A_Ethernet2
   neighbor 10.255.2.6 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.2.6 remote-as 65100
   neighbor 10.255.2.6 description LABRSPINE02A_Ethernet2
   neighbor 10.255.3.0 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 10.255.3.0 description LABRLEAF01A_Vlan4093
   ...
   vrf TEST_VRF
      ...
      update wait-install
      neighbor 10.255.3.0 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.3.0 description LABRLEAF01A_Vlan3000
